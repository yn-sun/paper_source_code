    ...
    for name in os.listdir(path):
        if 'flare-F' in name:
            ...
            if 'tra' in name:    
                ...
                #print(len(attr1))
                while line:
                    if '@attribute LargestSpotSize' in line and len(attr1)==0:
                        attr1=line[28:-2].replace(' ','').split(',')
                    elif '@attribute SpotDistribution' in line and len(attr2)==0:
                        attr2=line[29:-2].replace(' ','').split(',')
                    elif '@data' in line:
                        line=f.readline()
                        while line:
                            #for attr_1 in line
