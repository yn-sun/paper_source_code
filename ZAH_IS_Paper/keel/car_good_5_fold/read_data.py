    ...
    for name in os.listdir(path):
        if 'car-good' in name:
            ...
            if 'tra' in name:    
                ...
                #print(len(attr1))
                while line:
                    if '@attribute Buying' in line and len(attr1)==0:
                        attr1=line[19:-2].replace(' ','').split(',')
                    elif '@attribute Maint' in line and len(attr2)==0:
                        attr2=line[18:-2].replace(' ','').split(',')
                    elif '@attribute Doors' in line and len(attr3)==0:
                        attr3=line[18:-2].replace(' ','').split(',')
                    elif '@attribute Persons' in line and len(attr4)==0:
                        attr4=line[20:-2].replace(' ','').split(',')
                    elif '@attribute Lug_boot' in line and len(attr5)==0:
                        attr5=line[21:-2].replace(' ','').split(',')
                    elif '@attribute Safety' in line and len(attr6)==0:
                        attr6=line[19:-2].replace(' ','').split(',')
                    elif '@data' in line:
                        line=f.readline()
                        while line:
                            #for attr_1 in line
...
if __name__=='__main__':
    path='../keel/car_good_5_fold/'
    train_data_all,test_data_all=read_data(path)
