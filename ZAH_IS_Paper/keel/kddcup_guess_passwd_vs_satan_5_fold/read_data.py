    ...
    for name in os.listdir(path):
        if 'kddcup' in name:
            ...
            if 'tra' in name:    
                ...
                #print(len(attr1))
                while line:
                    if '@attribute Atr-1' in line and len(attr1)==0:
                        attr1=line[18:-2].replace(' ','').split(',')
                    elif '@attribute Atr-2' in line and len(attr2)==0:
                        attr2=line[18:-2].replace(' ','').split(',')
                    elif '@attribute Atr-3' in line and len(attr3)==0:
