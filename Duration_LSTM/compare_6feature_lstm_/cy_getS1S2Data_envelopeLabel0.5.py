...
def getS1S2DataList(NameList,EnvelopDict,LabelDict,HeartRateDict,sampleLength=200, sampleNumber=200):
    ...
    print s1s2List
    heartSoundList=np.reshape(heartSoundList,(-1,sampleLength,6))
...
if __name__ == '__main__':
    ...
    TrainList,TrainLabelList,Trains1s2List=getS1S2DataList(trainNameList,EnvelopDict,LabelDict,HeartRateDict,200,20)
    TestList,TestLabelList,Tests1s2List=getS1S2DataList(testNameList,EnvelopDict,LabelDict,HeartRateDict,200,20)
